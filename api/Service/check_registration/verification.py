...
from api.Model.circonscription.models import Commune, Arrondissement, Departement, Region, commune_schema, \
    arrondissement_schema, departement_schema, region_schema
from api.Model.elector.model import Elector, elector_schema
